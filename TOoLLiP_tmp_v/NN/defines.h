...
typedef ap_fixed<14,8,AP_TRN,AP_SAT,0> q_separableconv1d_accum_t;
typedef ap_fixed<14,8,AP_TRN,AP_SAT,0> layer3_t;
typedef ap_fixed<14,8,AP_TRN,AP_SAT,0> q_separableconv1d_weight_t;
typedef ap_fixed<12,7> bias3_t;
typedef ap_ufixed<14,8,AP_TRN,AP_SAT,0> layer5_t;
typedef ap_fixed<18,8> q_activation_table_t;
typedef ap_fixed<16,12,AP_TRN,AP_SAT,0> q_separableconv1d_2_accum_t;
typedef ap_fixed<14,8,AP_TRN,AP_SAT,0> layer6_t;
typedef ap_fixed<14,8,AP_TRN,AP_SAT,0> q_separableconv1d_2_weight_t;
typedef ap_fixed<12,7> bias6_t;
...
typedef ap_fixed<12,7> weight10_t;
typedef ap_fixed<12,7> bias10_t;
