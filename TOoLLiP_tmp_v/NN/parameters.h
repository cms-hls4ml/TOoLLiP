...
struct config15 : nnet::conv1d_config {
    ...
    template<class data_T, class res_T, class CONFIG_T>
    using conv_kernel = hls4ml_model_emu_tmp_v::pointwise_conv_15<data_T, res_T, CONFIG_T>;
};
...
struct config16 : nnet::conv1d_config {
    ...
    using scale_index = nnet::scale_index_regular<K, S, W>;
    template<class data_T, class res_T, class CONFIG_T>
    using conv_kernel = hls4ml_model_emu_tmp_v::pointwise_conv_16<data_T, res_T, CONFIG_T>;
};
