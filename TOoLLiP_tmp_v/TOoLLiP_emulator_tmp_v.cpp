#include "NN/TOoLLiP_tmp_v.h" //include of the top level of HLS model
#include "emulator.h" //include of emulator modeling
#include <any>
#include "ap_fixed.h"

using namespace hls4ml_model_emu_tmp_v;

class TOoLLiP_emulator_tmp_v : public hls4mlEmulator::Model{
    private:
...
{
    return new TOoLLiP_emulator_tmp_v;
}
