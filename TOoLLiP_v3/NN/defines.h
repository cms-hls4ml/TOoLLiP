...
typedef ap_ufixed<14,8,AP_TRN,AP_SAT,0> layer8_t;
typedef ap_fixed<18,8> q_activation_1_table_t;
typedef ap_fixed<16,8,AP_TRN,AP_SAT,0> global_average_pooling1d_accum_t;
typedef ap_fixed<14,8,AP_TRN,AP_SAT,0> layer9_t;
typedef ap_fixed<16,8,AP_TRN,AP_SAT,0> q_dense_accum_t;
...
typedef ap_fixed<16,8,AP_TRN,AP_SAT,0> q_dense_1_accum_t;
